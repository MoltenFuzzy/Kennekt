...
const Login: NextPage = () => {
  ...
  // TODO: causes flash of login page before redirecting to home
  useEffect(() => {
  ...
  if (sessionData?.user) {
    return (
      <div className="min-h-screen bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-slate-900 via-slate-800 to-zinc-900"></div>
    );
  }
